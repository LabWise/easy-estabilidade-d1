-- Remover função existente e recriar com parâmetros corretos
...
-- Criar função atualizada para trabalhar com códigos de versão individual
...
BEGIN
  ...
  INSERT INTO public.retiradas_amostras (
    ...
    v_amostra_id,
    p_codigo_versao, -- Usar código de versão em vez do código base
    p_usuario,
    p_status_textual,
    p_metodo,
    p_observacoes,
